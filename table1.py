...
table1_tags = [
    ("LRCN", "lrcn_beam5_test", "lrcn-sc_beam5_test"),
...
print(
    "Model\tSPICE\tMETEOR\tCIDEr\tCHAIRs\tCHAIRi\t|SPICE\tMETEOR\tCIDEr\tCHAIRs\tCHAIRi"
)
...
for tag in table1_tags:
    ...
    if len(tag) > 2:
        ...
        metric_string_sc = "-\t-\t-\t-\t-"
    print(f"{tag[0]}\t{metric_string_ce}\t|{metric_string_sc}")
