...
Rohrbach*, Anna and Hendricks*, Lisa Anne, et al. ["Object Hallucination in Image Captioning."](https://arxiv.org/pdf/1809.02156.pdf) EMNLP (2018).
...
If you would like to run `figure4.py` (language and image model consistency) you will need to download some intermediate features. Please see the _Language and Image Model Consistency_ section below.
